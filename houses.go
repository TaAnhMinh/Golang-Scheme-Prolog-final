	...
	listings := []RealEstate{
		{Condo: Condo{
			ListingInfo: ListingInfo {
				"Goulburn Ave 1120", 750000, false,},
				CondoFees: 900}},
		{Condo: Condo{
			ListingInfo: ListingInfo{
				"Summerset Street 10", 950000, false,},
				CondoFees: 850}},  
		{Condo: Condo{
			ListingInfo: ListingInfo{
				"Wilbord Avenue 999", 1250000, false,},
				CondoFees: 1250}},
				}	
	// ** QUESTION 3 c) Add a TownHouse of 2 levels at "Elgin 123" for $2100000 to listings
	listings = append(listings, TownHouse { TownHouse.ListingInfo{ "Elgin 123", 2100000, false,}, FloorLevels: 2,})
	// ** QUESTION 3 c) Add a House at "Maplewood 889" for $850000 with lot size of 50 x 110 to listings
	listings = append(listings, House{ House.ListingInfo{"Maplewood 889",850000, false,}, House.Lotsize.Width: 50, House.Lotsize.Length: 110})
